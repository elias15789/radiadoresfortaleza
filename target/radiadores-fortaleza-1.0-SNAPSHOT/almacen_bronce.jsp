...
<head>
  ...
  <title>Almacén de Bronce - Radiadores Fortaleza</title>
      ...
      <li class="nav-item active">
        ...
        <div id="collapseAlmacen" class="collapse show" aria-labelledby="headingAlmacen" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="AlmacenServlet?accion=VerBronce">Radiadores de Bronce</a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseProveedores" class="collapse" aria-labelledby="headingProveedores" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="#">Gestionar Proveedores</a>
            <a class="collapse-item" href="#">Órdenes de Compra</a>
          </div>
        </div>
      </li>
      <% } %>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
            ...
            <div class="col-md-6">
              <div class="card card-stats">
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h6 class="text-uppercase mb-0">Productos de Bronce</h6>
                        ...
                        <% 
                          ...
                          if (productos != null) {
                            for (Producto p : productos) {
                              if ("Bronce".equalsIgnoreCase(p.getTipo())) {
                                totalBronce++;
                              }
                            }
                          }
                          out.print(totalBronce);
                        %>
                      </span>
                    </div>
                    <div class="col-auto">
                      ...
                      <span class="h2 font-weight-bold mb-0">
                        <% 
                          ...
                          if (productos != null) {
                            for (Producto p : productos) {
                              if ("Bronce".equalsIgnoreCase(p.getTipo())) {
                                stockBronce += p.getCantidad();
                              }
                            }
                          }
                          out.print(stockBronce);
                        %>
                      </span>
                    </div>
                    <div class="col-auto">
          ...
          <div class="search-box">
            <h5 style="color: #cc3333;" class="mb-3"><i class="fas fa-search"></i> Buscar Producto de Bronce</h5>
            <form action="AlmacenServlet" method="post">
              <input type="hidden" name="accion" value="Buscar">
              <div class="row">
                <div class="col-md-8">
                  <input type="text" name="nombre" class="form-control" placeholder="Nombre del producto de bronce..." required>
                </div>
                <div class="col-md-4">
          ...
          <!-- Lista de Productos de Bronce -->
          <div class="card shadow">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold" style="color: #cc3333;">
                <i class="fas fa-medal"></i> Radiadores de Bronce
              </h6>
            </div>
            <div class="card-body">
              <% if (productos != null && !productos.isEmpty()) { 
                   boolean hayBronce = false;
                   for (Producto p : productos) {
                     if ("Bronce".equalsIgnoreCase(p.getTipo())) {
                       hayBronce = true;
                       break;
                    ...
                    <tbody>
                      <% for (Producto p : productos) { 
                        ...
                        <tr>
                          <td><%= p.getNombre() %></td>
                          <td><%= p.getModelo() %></td>
                          <td><span class="badge badge-warning"><%= p.getTipo() %></span></td>
              ...
              <% } else { %>
                <div class="text-center text-muted py-4">
                  ...
                  <h4>No hay productos de bronce</h4>
                  <p>No se encontraron radiadores de bronce en el inventario.</p>
                </div>
              <% } } else { %>
                <div class="text-center text-muted py-4">
                  <i class="fas fa-medal fa-3x mb-3"></i>
